...
public class Hauptfenster extends JFrame implements TableModelListener{
    ...
    public Hauptfenster() {
        ...
        BerechneFunktional.addActionListener(arg0 -> JOptionPane.showMessageDialog(null, "Achtung! Die funktionale F�rbung ist nur mit einem planaren Graphen m�glich. Es existiert keine Pr�fung des von Ihnen eingegebenen Grpahen auf planarit�t. Weitere Informationen: de.wikipedia.org/wiki/Planarer_Graph ", "Achtung", JOptionPane.INFORMATION_MESSAGE));
